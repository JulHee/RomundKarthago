...
public class Mechanik implements Cloneable
{
	 ...
	 */
	public static void Transition (String Graphpath,
	 ...
	 */
	public String auswerten (String zug,
							 Seite spieler)
	{
		String error;
					  ...
					  AIPlayer kathargo)
	{
		...
		while ( spiel )
		{
			...
			System.out.println( aktuellerSpieler.meineSeite.toString() + " spielt folgenden Zug: " + zug );
		...
		System.out.println( "Rom hat " + myGraph.getPunkteStandFuer( Seite.Rom ) + " Punkt(e)" );
		System.out.println( "Kathargo hat " + myGraph.getPunkteStandFuer( Seite.Kathargo ) + " Punkt(e)" );
	}
	...
	public void game (AIPlayer computer)
	{
		...
		if ( computer.meineSeite == Seite.Rom )
		{
			while ( spiel )
			{
				...
				aktuellerSpieler = ( aktuellerSpieler == Seite.Rom ) ? Seite.Kathargo : Seite.Rom;
	...
	public Mechanik clone ()
	{
		try
		{
			Mechanik cloneMechanik = new Mechanik( this.path, this.myGraph.clone(), this.letzterZugAusgesetzt,
												   this.spiel );
